...
function obtenerImagenFondo(tipo, appDir) {
    const intentos = [
        path.join(appDir, 'frontend', 'public', 'img', `cert_${tipo}.jpg`),
        path.join(appDir, 'frontend', 'public', 'img', `cert_${tipo}.png`),
        path.join(appDir, 'frontend', 'public', 'img', 'cert_base.jpg'),
        path.join(appDir, 'frontend', 'public', 'img', 'cert_base.png'),
    ];
...
exports.guardarImagenBase = async (req, res) => {
    try {
        ...
        if (isProduction) {
            ...
            const dest = path.join(__dirname, '..', '..', 'frontend', 'public', 'img', `cert_base${ext}`);
