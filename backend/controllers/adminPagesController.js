...
const PAGE_KEYS = {
    ...
    autoridades: {
        ...
        sections: [
            ...
            {
                id: 'test_aut',
                title: '5b. Testimonios',
                desc: 'Citas de autoridades de ediciones anteriores.',
                color: '#A02140', bg: '#F9E8EC',
                icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z',
                keys: [
                    { key: 'text_aut_testimonials_badge', label: 'Badge',               type: 'text'     },
                    { key: 'text_aut_testimonials_title', label: 'Título',              type: 'text'     },
                    { key: 'text_aut_testimonials_desc',  label: 'Descripción',         type: 'textarea' },
                    { key: 'text_aut_test_1_name',      label: 'Testimonio 1 - Nombre', type: 'text'     },
                    { key: 'text_aut_test_1_role',      label: 'Testimonio 1 - Rol',    type: 'text'     },
                    { key: 'text_aut_test_1_quote',     label: 'Testimonio 1 - Cita',   type: 'textarea' },
                    { key: 'text_aut_test_2_name',      label: 'Testimonio 2 - Nombre', type: 'text'     },
                    { key: 'text_aut_test_2_role',      label: 'Testimonio 2 - Rol',    type: 'text'     },
                    { key: 'text_aut_test_2_quote',     label: 'Testimonio 2 - Cita',   type: 'textarea' },
                    { key: 'text_aut_test_3_name',      label: 'Testimonio 3 - Nombre', type: 'text'     },
                    { key: 'text_aut_test_3_role',      label: 'Testimonio 3 - Rol',    type: 'text'     },
                    { key: 'text_aut_test_3_quote',     label: 'Testimonio 3 - Cita',   type: 'textarea' },
                ]
            },
            {
                id: 'faq_aut',
        ...
        sections: [
            {
                ...
                icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',
                keys: [
                    { key: 'text_del_badge',          label: 'Badge',                 type: 'text'     },
                    { key: 'text_del_hero_title',     label: 'Título',                type: 'text'     },
                    { key: 'text_del_hero_highlight', label: 'Frase destacada',       type: 'text'     },
                    { key: 'text_del_hero_desc',      label: 'Descripción',           type: 'textarea' },
                    { key: 'text_del_cta_secondary',  label: 'Botón CTA',             type: 'text'     },
                ]
            },
            {
                id: 'trust_del',
                title: '2. Colegios (Strip)',
                desc: 'Banda animada de nombres de colegios o instituciones.',
                color: '#8A8A8D', bg: '#F3F3F4',
                icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5',
                keys: [
                    { key: 'show_trust_strip',        label: 'Mostrar sección (true/false)', type: 'checkbox' },
                    { key: 'trust_strip_label',       label: 'Etiqueta superior',     type: 'text'     },
                    { key: 'trust_1',                 label: 'Colegio 1',             type: 'text'     },
                    { key: 'trust_2',                 label: 'Colegio 2',             type: 'text'     },
                    { key: 'trust_3',                 label: 'Colegio 3',             type: 'text'     },
                    { key: 'trust_4',                 label: 'Colegio 4',             type: 'text'     },
                    { key: 'trust_5',                 label: 'Colegio 5',             type: 'text'     },
                    { key: 'trust_6',                 label: 'Colegio 6',             type: 'text'     },
                ]
            },
            {
                id: 'what_del',
                title: '3. El Rol del Delegado',
                desc: 'Descripción del rol y 4 tarjetas de características.',
                color: '#FFB819', bg: '#FEF6E0',
                icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                keys: [
                    { key: 'text_del_what_title',     label: 'Título',                type: 'text'     },
                    { key: 'text_del_what_desc',      label: 'Descripción',           type: 'textarea' },
                    { key: 'text_del_rol_1_title',    label: 'Tarjeta 1 - Título',    type: 'text'     },
                    { key: 'text_del_rol_1_desc',     label: 'Tarjeta 1 - Descripción',type: 'textarea' },
                    { key: 'text_del_rol_2_title',    label: 'Tarjeta 2 - Título',    type: 'text'     },
                    { key: 'text_del_rol_2_desc',     label: 'Tarjeta 2 - Descripción',type: 'textarea' },
                    { key: 'text_del_rol_3_title',    label: 'Tarjeta 3 - Título',    type: 'text'     },
                    { key: 'text_del_rol_3_desc',     label: 'Tarjeta 3 - Descripción',type: 'textarea' },
                    { key: 'text_del_rol_4_title',    label: 'Tarjeta 4 - Título',    type: 'text'     },
                    { key: 'text_del_rol_4_desc',     label: 'Tarjeta 4 - Descripción',type: 'textarea' },
                ]
            },
            {
                id: 'skills_del',
                title: '4. Habilidades y Estadísticas',
                desc: 'Textos de la sección Desarrollo Personal y dos fotos referenciales.',
                color: '#E15829', bg: '#FCEEE9',
                icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
                keys: [
                    { key: 'text_del_skills_badge',     label: 'Badge',                 type: 'text'     },
                    { key: 'text_del_skills_title',     label: 'Título',                type: 'text'     },
                    { key: 'text_del_skills_highlight', label: 'Frase destacada',       type: 'text'     },
                    { key: 'text_del_skills_desc',      label: 'Descripción',           type: 'textarea' },
                    { key: 'del_skills_img_1',          label: 'Foto Superior',         type: 'image'    },
                    { key: 'del_skills_img_2',          label: 'Foto Inferior',         type: 'image'    },
                ]
            },
            {
                id: 'path_del',
                title: '5. El Camino del Delegado',
                desc: 'Línea de tiempo con los pasos del delegado.',
                color: '#73A950', bg: '#EDF5E8',
                icon: 'M12 4v16m8-8H4',
                keys: [
                    { key: 'text_del_path_badge',       label: 'Badge',                 type: 'text'     },
                    { key: 'text_del_path_title',       label: 'Título',                type: 'text'     },
                    { key: 'text_del_path_desc',        label: 'Descripción',           type: 'textarea' },
                    { key: 'del_step_1_title',          label: 'Paso 1 - Título',       type: 'text'     },
                    { key: 'del_step_1_desc',           label: 'Paso 1 - Descripción',  type: 'textarea' },
                    { key: 'del_step_2_title',          label: 'Paso 2 - Título',       type: 'text'     },
                    { key: 'del_step_2_desc',           label: 'Paso 2 - Descripción',  type: 'textarea' },
                    { key: 'del_step_3_title',          label: 'Paso 3 - Título',       type: 'text'     },
                    { key: 'del_step_3_desc',           label: 'Paso 3 - Descripción',  type: 'textarea' },
                    { key: 'del_step_4_title',          label: 'Paso 4 - Título',       type: 'text'     },
                    { key: 'del_step_4_desc',           label: 'Paso 4 - Descripción',  type: 'textarea' },
                    { key: 'del_step_5_title',          label: 'Paso 5 - Título',       type: 'text'     },
                    { key: 'del_step_5_desc',           label: 'Paso 5 - Descripción',  type: 'textarea' },
                ]
            },
            {
                id: 'gallery_del',
                title: '6. Galería de Momentos',
                desc: 'Carrusel de fotos de ediciones anteriores.',
                color: '#61B4E4', bg: '#E8F5FB',
                icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z',
                keys: [
                    { key: 'text_del_gallery_badge',    label: 'Badge',                 type: 'text'     },
                    { key: 'text_del_gallery_title',    label: 'Título',                type: 'text'     },
                    { key: 'text_del_gallery_desc',     label: 'Descripción',           type: 'textarea' },
                ],
                dynamicImages: { prefix: 'del_legacy_', label: 'Foto del carrusel' }
            },
            {
                id: 'test_del',
                title: '7. Testimonios',
                desc: 'Citas de delegados de ediciones anteriores.',
                color: '#A02140', bg: '#F9E8EC',
                icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z',
                keys: [
                    { key: 'text_del_testimonials_badge', label: 'Badge',               type: 'text'     },
                    { key: 'text_del_testimonials_title', label: 'Título',              type: 'text'     },
                    { key: 'text_del_testimonials_desc',  label: 'Descripción',         type: 'textarea' },
                    { key: 'text_del_test_1_name',      label: 'Testimonio 1 - Nombre', type: 'text'     },
                    { key: 'text_del_test_1_role',      label: 'Testimonio 1 - Colegio',type: 'text'     },
                    { key: 'text_del_test_1_quote',     label: 'Testimonio 1 - Cita',   type: 'textarea' },
                    { key: 'text_del_test_2_name',      label: 'Testimonio 2 - Nombre', type: 'text'     },
                    { key: 'text_del_test_2_role',      label: 'Testimonio 2 - Colegio',type: 'text'     },
                    { key: 'text_del_test_2_quote',     label: 'Testimonio 2 - Cita',   type: 'textarea' },
                    { key: 'text_del_test_3_name',      label: 'Testimonio 3 - Nombre', type: 'text'     },
                    { key: 'text_del_test_3_role',      label: 'Testimonio 3 - Colegio',type: 'text'     },
                    { key: 'text_del_test_3_quote',     label: 'Testimonio 3 - Cita',   type: 'textarea' },
                ]
            },
            {
                id: 'resources_del',
                title: '8. Recursos y Capacitaciones',
                desc: 'Materiales para descargar o visualizar (videos, presentaciones, guías). Rellená los datos para habilitarlos.',
                color: '#FFB819', bg: '#FEF6E0',
                icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z',
                keys: [
                    { key: 'resource_video_1_title',    label: 'Video 1 - Título',      type: 'text' },
                    { key: 'resource_video_1_url',      label: 'Video 1 - URL (YouTube)',type: 'url' },
                    { key: 'resource_video_1_desc',     label: 'Video 1 - Descripción', type: 'text' },
                    { key: 'resource_video_2_title',    label: 'Video 2 - Título',      type: 'text' },
                    { key: 'resource_video_2_url',      label: 'Video 2 - URL (YouTube)',type: 'url' },
                    { key: 'resource_video_2_desc',     label: 'Video 2 - Descripción', type: 'text' },
                    { key: 'resource_ppt_1_title',      label: 'Presentación 1 - Título',type: 'text' },
                    { key: 'resource_ppt_1_url',        label: 'Presentación 1 - URL',  type: 'url' },
                    { key: 'resource_ppt_1_desc',       label: 'Presentación 1 - Descripción', type: 'text' },
                    { key: 'resource_ppt_2_title',      label: 'Presentación 2 - Título',type: 'text' },
                    { key: 'resource_ppt_2_url',        label: 'Presentación 2 - URL',  type: 'url' },
                    { key: 'resource_ppt_2_desc',       label: 'Presentación 2 - Descripción', type: 'text' },
                    { key: 'resource_doc_1_title',      label: 'Documento 1 - Título',  type: 'text' },
                    { key: 'resource_doc_1_url',        label: 'Documento 1 - URL',     type: 'url' },
                    { key: 'resource_doc_1_type',       label: 'Documento 1 - Tipo (PDF, DOC)', type: 'text' },
                    { key: 'resource_doc_2_title',      label: 'Documento 2 - Título',  type: 'text' },
                    { key: 'resource_doc_2_url',        label: 'Documento 2 - URL',     type: 'url' },
                    { key: 'resource_doc_2_type',       label: 'Documento 2 - Tipo (PDF, DOC)', type: 'text' },
                ]
            },
            {
                id: 'faq_del',
                title: '9. Preguntas Frecuentes',
                desc: 'Acordeón de dudas en la parte inferior.',
                color: '#73A950', bg: '#EDF5E8',
                icon: 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                keys: [
                    { key: 'text_del_faq_title',        label: 'Título',                type: 'text'     },
                    { key: 'text_del_faq_desc',         label: 'Descripción',           type: 'textarea' },
                    { key: 'text_del_faq_1_q',          label: 'Pregunta 1',            type: 'text'     },
                    { key: 'text_del_faq_1_a',          label: 'Respuesta 1',           type: 'textarea' },
                    { key: 'text_del_faq_2_q',          label: 'Pregunta 2',            type: 'text'     },
                    { key: 'text_del_faq_2_a',          label: 'Respuesta 2',           type: 'textarea' },
                    { key: 'text_del_faq_3_q',          label: 'Pregunta 3',            type: 'text'     },
                    { key: 'text_del_faq_3_a',          label: 'Respuesta 3',           type: 'textarea' },
                    { key: 'text_del_faq_4_q',          label: 'Pregunta 4',            type: 'text'     },
                    { key: 'text_del_faq_4_a',          label: 'Respuesta 4',           type: 'textarea' },
                    { key: 'text_del_faq_5_q',          label: 'Pregunta 5',            type: 'text'     },
                    { key: 'text_del_faq_5_a',          label: 'Respuesta 5',           type: 'textarea' },
                    { key: 'text_del_faq_6_q',          label: 'Pregunta 6',            type: 'text'     },
                    { key: 'text_del_faq_6_a',          label: 'Respuesta 6',           type: 'textarea' },
                ]
            }
        ]
    },
...
const ALL_DEFAULTS = {
    ...
    // ─── DELEGADOS ───
    text_del_badge:              { label: 'Delegados - Badge Hero',         type: 'text',          value: 'Delegados 2026' },
    text_del_hero_title:         { label: 'Delegados - Título Hero',        type: 'text',          value: 'Tu voz en el centro<br>' },
    text_del_hero_highlight:     { label: 'Delegados - Destacado Hero',     type: 'text',          value: 'del debate global.' },
    text_del_hero_desc:          { label: 'Delegados - Subtítulo Hero',     type: 'textarea',      value: 'Ponete en los zapatos de un diplomático, investigá sobre tu país asignado y defendé sus posturas frente a problemáticas reales que afectan al mundo de hoy.' },
    text_del_cta_secondary:      { label: 'Delegados - CTA Botón',          type: 'text',          value: 'Ver órganos de debate' },
    show_trust_strip:            { label: 'Delegados - Mostrar Colegios',   type: 'checkbox',      value: 'true' },
    trust_strip_label:           { label: 'Delegados - Texto Colegios',     type: 'text',          value: 'MÁS DE 20 COLEGIOS DE LA PROVINCIA YA PARTICIPAN' },
    trust_1:                     { label: 'Delegados - Colegio 1',          type: 'text',          value: 'Colegio Nacional' },
    trust_2:                     { label: 'Delegados - Colegio 2',          type: 'text',          value: 'Escuela Normal' },
    trust_3:                     { label: 'Delegados - Colegio 3',          type: 'text',          value: 'Instituto San Pedro' },
    trust_4:                     { label: 'Delegados - Colegio 4',          type: 'text',          value: 'Colegio del Centenario' },
    trust_5:                     { label: 'Delegados - Colegio 5',          type: 'text',          value: 'Liceo Remedios' },
    trust_6:                     { label: 'Delegados - Colegio 6',          type: 'text',          value: 'Instituto Belgrano' },
    text_del_what_title:         { label: 'Delegados - Qué Título',         type: 'text',          value: '¿Qué hace exactamente un delegado?' },
    text_del_what_desc:          { label: 'Delegados - Qué Desc',           type: 'textarea',      value: 'Durante los días del encuentro vas a representar los intereses de un país específico. Tendrás que debatir, negociar y buscar soluciones conjuntas con delegados de otras naciones.' },
    text_del_rol_1_title:        { label: 'Delegados - Rol 1 Título',       type: 'text',          value: 'Investigar y Conocer' },
    text_del_rol_1_desc:         { label: 'Delegados - Rol 1 Desc',         type: 'textarea',      value: 'Profundizar en la cultura, economía y política exterior del país que te fue asignado.' },
    text_del_rol_2_title:        { label: 'Delegados - Rol 2 Título',       type: 'text',          value: 'Debatir Ideas' },
    text_del_rol_2_desc:         { label: 'Delegados - Rol 2 Desc',         type: 'textarea',      value: 'Exponer la postura de tu nación frente a los tópicos a tratar utilizando oratoria persuasiva.' },
    text_del_rol_3_title:        { label: 'Delegados - Rol 3 Título',       type: 'text',          value: 'Negociar' },
    text_del_rol_3_desc:         { label: 'Delegados - Rol 3 Desc',         type: 'textarea',      value: 'Buscar aliados estratégicos y formar bloques para potenciar tus propuestas.' },
    text_del_rol_4_title:        { label: 'Delegados - Rol 4 Título',       type: 'text',          value: 'Redactar Tratados' },
    text_del_rol_4_desc:         { label: 'Delegados - Rol 4 Desc',         type: 'textarea',      value: 'Plasmar los acuerdos alcanzados en proyectos de resolución formales.' },
    text_del_skills_badge:       { label: 'Delegados - Habilidades Badge',  type: 'text',          value: 'Desarrollo Personal' },
    text_del_skills_title:       { label: 'Delegados - Habilidades Título', type: 'text',          value: 'Habilidades para tu futuro.' },
    text_del_skills_highlight:   { label: 'Delegados - Hab. Highlight',     type: 'text',          value: '' },
    text_del_skills_desc:        { label: 'Delegados - Habilidades Desc',   type: 'textarea',      value: 'Participar como delegado transforma tu manera de comunicarte. Aprenderás a estructurar argumentos, perder el miedo a hablar en público y liderar con empatía.' },
    del_skills_img_1:            { label: 'Delegados - Foto Habilidades 1', type: 'image',         value: '' },
    del_skills_img_2:            { label: 'Delegados - Foto Habilidades 2', type: 'image',         value: '' },
    text_del_path_badge:         { label: 'Delegados - Camino Badge',       type: 'text',          value: 'Paso a paso' },
    text_del_path_title:         { label: 'Delegados - Camino Título',      type: 'text',          value: 'El camino del delegado' },
    text_del_path_desc:          { label: 'Delegados - Camino Desc',        type: 'textarea',      value: 'Todo lo que pasa desde que te inscribís hasta que levantás tu cartel en el recinto.' },
    del_step_1_title:            { label: 'Delegados - Paso 1 Título',      type: 'text',          value: 'Inscripción del Colegio' },
    del_step_1_desc:             { label: 'Delegados - Paso 1 Desc',        type: 'textarea',      value: 'Tu escuela se anota y recibe los cupos disponibles para participar.' },
    del_step_2_title:            { label: 'Delegados - Paso 2 Título',      type: 'text',          value: 'Sorteo de Países' },
    del_step_2_desc:             { label: 'Delegados - Paso 2 Desc',        type: 'textarea',      value: 'La organización asigna qué país representará tu delegación.' },
    del_step_3_title:            { label: 'Delegados - Paso 3 Título',      type: 'text',          value: 'Capacitaciones' },
    del_step_3_desc:             { label: 'Delegados - Paso 3 Desc',        type: 'textarea',      value: 'Encuentros virtuales y presenciales para aprender a debatir.' },
    del_step_4_title:            { label: 'Delegados - Paso 4 Título',      type: 'text',          value: 'Investigación' },
    del_step_4_desc:             { label: 'Delegados - Paso 4 Desc',        type: 'textarea',      value: 'Preparación de discursos y postura oficial con tus compañeros.' },
    del_step_5_title:            { label: 'Delegados - Paso 5 Título',      type: 'text',          value: 'El Modelo' },
    del_step_5_desc:             { label: 'Delegados - Paso 5 Desc',        type: 'textarea',      value: 'Tres días a puro debate, negociaciones y nuevas amistades.' },
    text_del_gallery_badge:      { label: 'Delegados - Galería Badge',      type: 'text',          value: 'Momentos' },
    text_del_gallery_title:      { label: 'Delegados - Galería Título',     type: 'text',          value: 'Galería de Delegados' },
    text_del_gallery_desc:       { label: 'Delegados - Galería Desc',       type: 'textarea',      value: 'Un vistazo a lo que se vive dentro de los órganos.' },
    text_del_testimonials_badge: { label: 'Delegados - Testimonios Badge',  type: 'text',          value: 'Experiencias' },
    text_del_testimonials_title: { label: 'Delegados - Testimonios Título', type: 'text',          value: 'Lo que opinan los delegados' },
    text_del_testimonials_desc:  { label: 'Delegados - Testimonios Desc',   type: 'textarea',      value: 'Mirá cómo la experiencia impactó a participantes de ediciones anteriores.' },
    text_del_test_1_name:        { label: 'Delegados - Testimonio 1 Nombre',type: 'text',          value: 'Delegado de Japón' },
    text_del_test_1_role:        { label: 'Delegados - Testimonio 1 Rol',   type: 'text',          value: 'Colegio San José' },
    text_del_test_1_quote:       { label: 'Delegados - Testimonio 1 Cita',  type: 'textarea',      value: 'Aprendí más sobre política internacional en tres días que en todo un año escolar.' },
    text_del_test_2_name:        { label: 'Delegados - Testimonio 2 Nombre',type: 'text',          value: 'Delegada de Brasil' },
    text_del_test_2_role:        { label: 'Delegados - Testimonio 2 Rol',   type: 'text',          value: 'Escuela Normal' },
    text_del_test_2_quote:       { label: 'Delegados - Testimonio 2 Cita',  type: 'textarea',      value: 'Lo mejor es la gente que conocés. Te hacés amigo de personas de otros colegios que de otra forma nunca cruzarías.' },
    text_del_test_3_name:        { label: 'Delegados - Testimonio 3 Nombre',type: 'text',          value: 'Delegado de Sudáfrica' },
    text_del_test_3_role:        { label: 'Delegados - Testimonio 3 Rol',   type: 'text',          value: 'Colegio Nacional' },
    text_del_test_3_quote:       { label: 'Delegados - Testimonio 3 Cita',  type: 'textarea',      value: 'Entré con pánico de hablar por micrófono. Salí sintiendo que podía defender cualquier idea.' },
    resource_video_1_title:      { label: 'Delegados - Vid 1 Título',       type: 'text',          value: '¿Cómo funciona la ONU?' },
    resource_video_1_url:        { label: 'Delegados - Vid 1 URL',          type: 'url',           value: '' },
    resource_video_1_desc:       { label: 'Delegados - Vid 1 Desc',         type: 'text',          value: 'Un repaso breve por los órganos principales.' },
    resource_video_2_title:      { label: 'Delegados - Vid 2 Título',       type: 'text',          value: 'Tips de Oratoria' },
    resource_video_2_url:        { label: 'Delegados - Vid 2 URL',          type: 'url',           value: '' },
    resource_video_2_desc:       { label: 'Delegados - Vid 2 Desc',         type: 'text',          value: 'Cómo dar un buen discurso inicial.' },
    resource_ppt_1_title:        { label: 'Delegados - PPT 1 Título',       type: 'text',          value: 'Presentación Introductoria' },
    resource_ppt_1_url:          { label: 'Delegados - PPT 1 URL',          type: 'url',           value: '' },
    resource_ppt_1_desc:         { label: 'Delegados - PPT 1 Desc',         type: 'text',          value: 'Slides de la primera capacitación.' },
    resource_ppt_2_title:        { label: 'Delegados - PPT 2 Título',       type: 'text',          value: 'Redacción de Proyectos' },
    resource_ppt_2_url:          { label: 'Delegados - PPT 2 URL',          type: 'url',           value: '' },
    resource_ppt_2_desc:         { label: 'Delegados - PPT 2 Desc',         type: 'text',          value: 'Estructura de una resolución.' },
    resource_doc_1_title:        { label: 'Delegados - Doc 1 Título',       type: 'text',          value: 'Reglamento General' },
    resource_doc_1_url:          { label: 'Delegados - Doc 1 URL',          type: 'url',           value: '' },
    resource_doc_1_type:         { label: 'Delegados - Doc 1 Tipo',         type: 'text',          value: 'PDF' },
    resource_doc_2_title:        { label: 'Delegados - Doc 2 Título',       type: 'text',          value: 'Guía de Investigación' },
    resource_doc_2_url:          { label: 'Delegados - Doc 2 URL',          type: 'url',           value: '' },
    resource_doc_2_type:         { label: 'Delegados - Doc 2 Tipo',         type: 'text',          value: 'PDF' },
    text_del_faq_title:          { label: 'Delegados - FAQ Título',         type: 'text',          value: 'Preguntas Frecuentes' },
    text_del_faq_desc:           { label: 'Delegados - FAQ Desc',           type: 'textarea',      value: 'Resolvé tus dudas y animate a participar.' },
    text_del_faq_1_q:            { label: 'Delegados - FAQ 1 P',            type: 'text',          value: '¿Puedo elegir el país que voy a representar?' },
    text_del_faq_1_a:            { label: 'Delegados - FAQ 1 R',            type: 'textarea',      value: 'No, los países se asignan por sorteo a cada colegio para garantizar equidad.' },
    text_del_faq_2_q:            { label: 'Delegados - FAQ 2 P',            type: 'text',          value: '¿Tengo que saber mucho de política?' },
    text_del_faq_2_a:            { label: 'Delegados - FAQ 2 R',            type: 'textarea',      value: '¡Para nada! Vas a aprender todo investigando en equipo.' },
    text_del_faq_3_q:            { label: 'Delegados - FAQ 3 P',            type: 'text',          value: '¿Cómo me inscribo?' },
    text_del_faq_3_a:            { label: 'Delegados - FAQ 3 R',            type: 'textarea',      value: 'A través de tu colegio. Hablá con tu docente para que anote al establecimiento.' },
    text_del_faq_4_q:            { label: 'Delegados - FAQ 4 P',            type: 'text',          value: '¿Tiene algún costo?' },
    text_del_faq_4_a:            { label: 'Delegados - FAQ 4 R',            type: 'textarea',      value: 'La participación es 100% gratuita.' },
    text_del_faq_5_q:            { label: 'Delegados - FAQ 5 P',            type: 'text',          value: '¿Qué pasa si me equivoco al hablar?' },
    text_del_faq_5_a:            { label: 'Delegados - FAQ 5 R',            type: 'textarea',      value: 'Nada. Todos estamos aprendiendo. Es un espacio seguro para equivocarse.' },
    text_del_faq_6_q:            { label: 'Delegados - FAQ 6 P',            type: 'text',          value: '¿Necesito ir con uniforme?' },
    text_del_faq_6_a:            { label: 'Delegados - FAQ 6 R',            type: 'textarea',      value: 'Durante los días del modelo se exige vestimenta formal occidental (traje, camisa, vestido, etc).' },
    ...
    text_aut_testimonials_badge: { label: 'Aut - Testimonios Badge',  type: 'text',     value: 'Comunidad' },
    text_aut_testimonials_title: { label: 'Aut - Testimonios Título', type: 'text',     value: 'Voces de la experiencia' },
    text_aut_testimonials_desc:  { label: 'Aut - Testimonios Desc',   type: 'textarea', value: 'Lo que dicen quienes ya participaron, en sus propias palabras.' },
    text_aut_test_1_name:        { label: 'Aut - Testimonio 1 Nombre',type: 'text',     value: 'Autoridad Ejemplo' },
    text_aut_test_1_role:        { label: 'Aut - Testimonio 1 Rol',   type: 'text',     value: 'Ujier' },
    text_aut_test_1_quote:       { label: 'Aut - Testimonio 1 Cita',  type: 'textarea', value: 'Me divertí un montón.' },
    text_aut_test_2_name:        { label: 'Aut - Testimonio 2 Nombre',type: 'text',     value: 'Autoridad Ejemplo 2' },
    text_aut_test_2_role:        { label: 'Aut - Testimonio 2 Rol',   type: 'text',     value: 'Presidencia' },
    text_aut_test_2_quote:       { label: 'Aut - Testimonio 2 Cita',  type: 'textarea', value: 'Aprendí a liderar equipos.' },
    text_aut_test_3_name:        { label: 'Aut - Testimonio 3 Nombre',type: 'text',     value: 'Autoridad Ejemplo 3' },
    text_aut_test_3_role:        { label: 'Aut - Testimonio 3 Rol',   type: 'text',     value: 'Consejeros' },
    text_aut_test_3_quote:       { label: 'Aut - Testimonio 3 Cita',  type: 'textarea', value: 'Fue una experiencia increíble.' },
...
async function saveBody(body, files, page) { // <--- Agregamos 'page'
    ...
    if (page === 'delegados') dynamicPrefixes.push('del_legacy_');
    ...
    const allDynamicPrefixes = ['vol_slider_', 'auth_legacy_', 'del_legacy_']; 
